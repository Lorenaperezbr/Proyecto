...
############################## Ange
# velocidad_feb <- read.csv("autoscope_02_2021_velocidad.csv", header = TRUE, sep = ";")
# conteo_feb <- read.csv("autoscope_02_2021_volumen.csv", header = TRUE, sep = ";")
# velocidad_mar <- read.csv("autoscope_03_2021_velocidad.csv", header = TRUE, sep = ";")
# conteo_mar <- read.csv("autoscope_03_2021_volumen.csv", header = TRUE, sep = ";")
...
# QUEREMOS HACER UN JOIN DE LOS PUNTOS DE NUESTRA BASE "FEBRERO_MARZO" A LOS MUNICIPIOS DEFINIDOS EN EL SHAPEFILE "MUNICIPIOS". LOS MATCHEARÍAMOS POR LONGITUD Y LATITUD.
...
muestra %>% ggplot(aes(x=volume,y=velocidad_promedio)) +
  ...
  labs(x="Cantidad de vehículos detectados en el carril en los ?ltimos 5 minutos", 
       y="Promedio de  las velocidades durante los últimos 5 minutos") +
...
ggpairs(muestra, c(10,15), mapping = ggplot2::aes(color = cat_hora, alpha = 0.5),
        diag = list(continuous = wrap("densityDiag")),
        lower = list(continuous = wrap("points", alpha=0.9)))

ggpairs(muestra, c(10,15), mapping = ggplot2::aes(color = dia_semana, alpha = 0.5),
        diag = list(continuous = wrap("densityDiag")),
        lower = list(continuous = wrap("points", alpha=0.9)))

ggpairs(muestra, c(10,15), mapping = ggplot2::aes(color = cat_fecha, alpha = 0.5),
        diag = list(continuous = wrap("densityDiag")),
        lower = list(continuous = wrap("points", alpha=0.9)))
```
...
```{r data_source, echo = FALSE, include = FALSE}
# Carga de los data sets
conteo_feb <- readRDS("data/raw/conteo_feb.rds")
conteo_mar <- readRDS("data/raw/conteo_mar.rds")

velocidad_feb <- readRDS("data/raw/velocidad_feb.rds")
velocidad_mar <- readRDS("data/raw/velocidad_mar.rds")
...
# febrero <- inner_join(conteo_feb, velocidad_feb, by = c('cod_detector'='cod_detector', 'id_carril'='id_carril', 'fecha'='fecha', 'hora'='hora', 'latitud'='latitud', 'longitud'='longitud')) 
# marzo <- inner_join(conteo_mar, velocidad_mar, by = c('cod_detector'='cod_detector', 'id_carril'='id_carril', 'fecha'='fecha', 'hora'='hora', 'latitud'='latitud', 'longitud'='longitud')) 
...
>>>>>>> fa384cec650c0df8239a7c27cb4fcefbc807f273
