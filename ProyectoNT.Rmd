...
p2<-base %>% ggplot(aes(x=factor(CCZ), y=volume)) +  geom_boxplot(aes(fill = CCZ)) +
 labs(x="Centro Comunal Zonal", y="Conteo de Vehículos")
...
muestra %>% ggplot(aes(x=volume,y=velocidad_promedio)) +
  ...
  labs(x="Cantidad de vehículos detectados en el carril en los últimos 5 minutos", 
       y="Promedio de  las velocidades de los autos que circularon por el carril durante los últimos 5 minutos") +
...
muestra %>% 
  ggplot(aes(x = cat_fecha, y=volume)) +
  geom_col() +
